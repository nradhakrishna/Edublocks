...
class RecordDetails extends Component
{
    state = {ipfsHash: '', buffer: null, web3: null, accounts: null, contract: null,
      ...
      constructor(props) {
        super(props);
        this.captureHash = this.captureHash.bind(this);
      ...
      captureHash(event) {
        ...
        const hash = event.target.value; // Assuming the hash is provided through an input field
      ...
      onSubmit(event) {
        ...
        // Check if IPFS hash is present
        if (!ipfsHash) {
          console.error("IPFS hash is missing.");
          return;
        }
      
        // Call contract method with the IPFS hash
        ...
        return(
            ...
            <form onSubmit={this.onSubmit} id="donateForm" className="donate-form">
                ...
                <div className="row">
                    <div className="col-sm-8">
                        <div className="form-group required">
                            <label for="payment">IPFS hash</label>
                            <input className="form-control" type="text" onChange={this.captureHash} />
